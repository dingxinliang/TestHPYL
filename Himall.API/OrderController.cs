    ...
    public class OrderController : BaseApiController
    {
            ...
            List<FightGroupOrderJoinStatus> list = new List<FightGroupOrderJoinStatus>()
      {
        ...
        FightGroupOrderJoinStatus.JoinSuccess
            ...
            try
            {
                OrderCreateModel groupOrder = OrderApplication.GetGroupOrder(this.CurrentUser.Id, skuId, count.ToString(), recieveAddressId, invoiceType, invoiceTitle, invoiceCode, invoiceContext, groupActionId, PlatformType.Android, groupId, isCashOnDelivery, orderRemarks, capitalAmount);
