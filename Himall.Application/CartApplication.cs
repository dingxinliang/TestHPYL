...
namespace Himall.Application
{
    public class CartApplication
    {
        ...
        /// <returns></returns>
        public static ShoppingCartInfo GetShopBranchCart(long memeberId, long shopbranchId = 0L)
        {
            return CartApplication._iBranchCartService.GetCart(memeberId, shopbranchId);
        }
