...
namespace Himall.Service
{
    public class SlideAdsService : ServiceBase, ISlideAdsService
    {
        ...
        public SlideAdInfo UpdateSlidAd(Model.SlideAdInfo models)
        {
        ...
        {
            return (IEnumerable<SlideAdInfo>)Enumerable.ToList<SlideAdInfo>((IEnumerable<SlideAdInfo>)Queryable.OrderBy<SlideAdInfo, long>(Queryable.Where<SlideAdInfo>((IQueryable<SlideAdInfo>)this.Context.SlideAdInfo, (Expression<Func<SlideAdInfo, bool>>)(s => s.ShopId == shopId && Enumerable.Contains<SlideAdInfo.SlideAdType>(types, s.TypeId))), (Expression<Func<SlideAdInfo, long>>)(t => t.DisplaySequence)));
        }
    }
}
