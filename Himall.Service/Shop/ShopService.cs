...
namespace Himall.Service
{
    public class ShopService : ServiceBase, IShopService
    {
        ...
        {
            return Enumerable.ToList<ShopInfo>(Enumerable.Where<ShopInfo>((IEnumerable<ShopInfo>)Enumerable.ToList<ShopInfo>(Enumerable.Where<ShopInfo>((IEnumerable<ShopInfo>)Enumerable.ToList<ShopInfo>(Enumerable.Where<ShopInfo>((IEnumerable<ShopInfo>)Enumerable.ToList<ShopInfo>((IEnumerable<ShopInfo>)Queryable.Where<ShopInfo>((IQueryable<ShopInfo>)this.Context.ShopInfo, (Expression<Func<ShopInfo, bool>>)(x => (int)x.ShopStatus != 2))), (Func<ShopInfo, bool>)(x => x.ShopStatus != ShopInfo.ShopAuditStatus.Refuse))), (Func<ShopInfo, bool>)(x => x.ShopStatus != ShopInfo.ShopAuditStatus.Unusable))), (Func<ShopInfo, bool>)(x => x.ShopStatus != ShopInfo.ShopAuditStatus.WaitConfirm)));
        }
        /// <summary>
        /// 根据Code查询
        /// </summary>
        ...
        /// <returns></returns>
        public ShopWdgjSetting GetshopInfoByCode(string uCode)
        {
            return Queryable.FirstOrDefault<ShopWdgjSetting>(Queryable.Where<ShopWdgjSetting>((IQueryable<ShopWdgjSetting>)this.Context.ShopWdgjSetting, (Expression<Func<ShopWdgjSetting, bool>>)(a => a.uCode == uCode)));
        }
        /// <summary>
        /// 根据ID查询
        /// </summary>
        /// <param name="shopId"></param>
        /// <returns></returns>
        public ShopWdgjSetting GetshopWdgjInfoById(long shopId)
        {
            return Queryable.FirstOrDefault<ShopWdgjSetting>(Queryable.Where<ShopWdgjSetting>((IQueryable<ShopWdgjSetting>)this.Context.ShopWdgjSetting, (Expression<Func<ShopWdgjSetting, bool>>)(a => a.ShopId == shopId)));
        }
        /// <summary>
        /// 更新数据信息
        /// </summary>
        /// <param name="wdgj"></param>
        public void UpdateShopWdgj(ShopWdgjSetting wdgj)
        {
            ShopWdgjSetting byId = DbSetExtend.FindById<ShopWdgjSetting>(this.Context.ShopWdgjSetting, (object)wdgj.Id);
            byId.uCode = wdgj.uCode;
            byId.uSign = wdgj.uSign;
        ...
        /// </summary>
        /// <param name="wdgj"></param>
        public void AddShopWdgj(ShopWdgjSetting wdgj)
        {
            this.Context.ShopWdgjSetting.Add(wdgj);
            this.Context.SaveChanges();
        }
    }
}
