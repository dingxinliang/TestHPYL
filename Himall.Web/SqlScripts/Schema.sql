...
-- ----------------------------
-- Table structure for Himall_ProductCircle
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ProductCircle`;
CREATE TABLE `Himall_ProductCircle` (
  `CircleId` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Himall_AccountDetails` (
  ...
  `OrderType` int(11) NOT NULL COMMENT '枚举 完成预约单1，退预约单0',
  `OrderId` bigint(20) NOT NULL COMMENT '预约单ID',
  `OrderAmount` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '预约单金额',
  `ProductActualPaidAmount` decimal(18,2) NOT NULL COMMENT '诊疗项目实付总额',
...
) ENGINE=InnoDB AUTO_INCREMENT=759 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Active` (
  ...
  `IsAllProduct` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否全部诊疗项目',
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 COMMENT='营销活动表';
...
CREATE TABLE `Himall_ActiveProducts` (
  ...
  `ProductId` bigint(20) NOT NULL COMMENT '产品编号 -1表示所有诊疗项目',
  PRIMARY KEY (`Id`),
  KEY `IDX_Himall_Accts_ActiveId` (`ActiveId`),
  KEY `IDX_Himall_Accts_ProdcutId` (`ProductId`)
) ENGINE=InnoDB AUTO_INCREMENT=663 DEFAULT CHARSET=utf8 COMMENT='营销活动诊疗项目';
...
CREATE TABLE `Himall_ApplyWithDraw` (
  ...
  `ApplyType` int(11) DEFAULT '1' COMMENT '提现方式',
  `Poundage` decimal(18,2) DEFAULT '0.00' COMMENT '手续费',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `Himall_AppMessages` (
  ...
  `TypeId` int(20) NOT NULL COMMENT '消息类型，对应枚举(1=预约单，2=售后)',
  `SourceId` bigint(20) NOT NULL COMMENT '数据来源编号，对应预约单ID或者售后ID',
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1227 DEFAULT CHARSET=utf8 COMMENT='APP消息通知表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6504 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_BrokerageIncome` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `OrderId` bigint(20) DEFAULT NULL COMMENT '预约单编号',
  `OrderItemId` bigint(20) DEFAULT NULL COMMENT '预约单条目编号',
...
) ENGINE=InnoDB AUTO_INCREMENT=3903 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3631 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_CollocationPoruducts` (
  ...
  `IsMain` tinyint(1) NOT NULL COMMENT '是否主诊疗项目',
...
CREATE TABLE `Himall_CollocationSkus` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID自增',
  `ProductId` bigint(20) NOT NULL COMMENT '诊疗项目ID',
  `SkuID` varchar(100) NOT NULL COMMENT '诊疗项目SkuId',
  `ColloProductId` bigint(20) NOT NULL COMMENT '组合诊疗项目表ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=869 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_CouponRecord` (
  ...
  `OrderId` bigint(20) DEFAULT NULL COMMENT '使用的预约单ID',
  `ShopId` bigint(20) NOT NULL,
  `ShopName` varchar(100) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2066 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='注册送优惠券关联优惠券';
...
CREATE TABLE `Himall_FightGroupActive` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='拼团活动';
...
CREATE TABLE `Himall_FightGroupActiveItem` (
  ...
  `ProductId` bigint(20) DEFAULT NULL COMMENT '诊疗项目编号',
  `SkuId` varchar(100) DEFAULT NULL COMMENT '诊疗项目SKU',
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8 COMMENT='拼团活动项';
...
CREATE TABLE `Himall_FightGroupOrder` (
  ...
  `ProductId` bigint(20) DEFAULT NULL COMMENT '对应诊疗项目',
  `SkuId` varchar(100) DEFAULT NULL COMMENT '诊疗项目SKU',
  `GroupId` bigint(20) DEFAULT NULL COMMENT '所属拼团',
  `OrderId` bigint(20) DEFAULT NULL COMMENT '预约单时间',
  `OrderUserId` bigint(20) DEFAULT NULL COMMENT '预约单用户编号',
  `IsFirstOrder` bit(1) DEFAULT NULL COMMENT '是否团首预约单',
...
) ENGINE=InnoDB AUTO_INCREMENT=5513 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=491 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=651 DEFAULT CHARSET=utf8 COMMENT='满减规则';
...
CREATE TABLE `Himall_GiftsOrder` (
  ...
  `OrderStatus` int(11) NOT NULL COMMENT '预约单状态',
...
) ENGINE=InnoDB AUTO_INCREMENT=2373 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ImageAds` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=6763 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3198 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=747 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Members` (
  ...
  `ParentSellerId` bigint(20) NOT NULL DEFAULT '0' COMMENT '诊所父账号ID',
  `Remark` varchar(1000) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=715 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
-- ----------------------------
-- Table structure for Himall_MobileFootMenus
-- ----------------------------
DROP TABLE IF EXISTS `Himall_MobileFootMenus`;
CREATE TABLE `Himall_MobileFootMenus` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=719 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_OrderComplaints` (
  ...
  `SellerReply` varchar(1000) DEFAULT NULL COMMENT '诊所反馈信息',
  PRIMARY KEY (`Id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3339 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2551 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_OrderPay` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1752 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_OrderRefundLogs` (
  ...
  `Remark` varchar(255) DEFAULT NULL COMMENT '备注(患者留言/诊所留言/诊所拒绝原因/平台退款备注)',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1000 DEFAULT CHARSET=utf8 COMMENT='预约单售后日志表';
...
CREATE TABLE `Himall_OrderRefunds` (
  ...
  `SellerAuditStatus` int(11) NOT NULL COMMENT '诊所审核状态',
  `SellerAuditDate` datetime NOT NULL COMMENT '诊所审核时间',
  `SellerRemark` varchar(1000) DEFAULT NULL COMMENT '诊所注释',
...
CREATE TABLE `Himall_Orders` (
  ...
  `ShipOrderNumber` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '物流预约单号',
  ...
  `InvoiceCode` varchar(100) DEFAULT NULL COMMENT '税号',
  `Tax` decimal(8,2) NOT NULL COMMENT '税钱，但是未使用',
  `FinishDate` datetime DEFAULT NULL COMMENT '完成预约单日期',
  `ProductTotalAmount` decimal(18,2) NOT NULL COMMENT '诊疗项目总金额',
  `RefundTotalAmount` decimal(18,2) NOT NULL COMMENT '退款金额',
  ...
  `Platform` int(11) NOT NULL DEFAULT '0' COMMENT '来自哪个终端的预约单',
  `DiscountAmount` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '针对该预约单的优惠金额（用于优惠券）',
  ...
  `TotalAmount` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '预约单实付金额',
  `ActualPayAmount` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '预约单实收金额',
...
CREATE TABLE `Himall_PendingSettlementOrders` (
  ...
  `PaymentTypeName` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=422 DEFAULT CHARSET=utf8 COMMENT='待结算预约单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=403 DEFAULT CHARSET=utf8 COMMENT='平台资金流水表';
...
CREATE TABLE `Himall_PlatVisits` (
  ...
  `OrderCount` bigint(20) NOT NULL COMMENT '预约单数',
  ...
  `OrderPayCount` bigint(20) NOT NULL COMMENT '付款预约单数',
...
) ENGINE=InnoDB AUTO_INCREMENT=6294 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ProductRelationProducts` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `ProductId` bigint(20) NOT NULL COMMENT '诊疗项目id',
  `Relation` varchar(255) NOT NULL COMMENT '推荐的诊疗项目id列表，以‘，’分隔',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='推荐诊疗项目';
...
) ENGINE=InnoDB AUTO_INCREMENT=2234 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=7606 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ReceivingAddressConfig` (
  ...
  `ShopId` bigint(20) NOT NULL COMMENT '预留字段，防止将来其他诊所一并支持货到付款',
  PRIMARY KEY (`Id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1729 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_SearchProducts` (
  ...
  `ImagePath` varchar(100) NOT NULL DEFAULT '' COMMENT '诊疗项目图片地址',
...
CREATE TABLE `Himall_SellerSpecificationValues` (
  ...
  `TypeId` bigint(20) NOT NULL COMMENT '类型ID',
  `Value` varchar(100) NOT NULL COMMENT '诊所的规格值',
  PRIMARY KEY (`Id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='发送优惠券详细';
...
CREATE TABLE `Himall_Settled` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `BusinessType` int(11) NOT NULL COMMENT '诊所类型 0、仅企业可入驻；1、仅个人可入驻；2、企业和个人均可',
  `SettlementAccountType` int(11) NOT NULL COMMENT '诊所结算类型 0、仅银行账户；1、仅微信账户；2、银行账户及微信账户均可',
...
CREATE TABLE `Himall_ShopBonusReceive` (
  ...
  `UsedOrderId` bigint(20) DEFAULT NULL COMMENT '使用的预约单号',
...
) ENGINE=InnoDB AUTO_INCREMENT=21184 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShopBranch` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=utf8 COMMENT='门店信息表';

-- ----------------------------
-- Table structure for Himall_ShopBranchInTags
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ShopBranchInTags`;
CREATE TABLE `Himall_ShopBranchInTags` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ShopBranchId` bigint(20) NOT NULL COMMENT '门店管理ID',
  `ShopBranchTagId` bigint(20) NOT NULL COMMENT '门店标签关联ID',
  PRIMARY KEY (`Id`),
  KEY `FK_ShopBranchId` (`ShopBranchId`),
  KEY `FK_ShopBranchTagId` (`ShopBranchTagId`),
  CONSTRAINT `FK_ShopBranchId` FOREIGN KEY (`ShopBranchId`) REFERENCES `Himall_ShopBranch` (`Id`),
  CONSTRAINT `FK_ShopBranchTagId` FOREIGN KEY (`ShopBranchTagId`) REFERENCES `Himall_ShopBranchTags` (`Id`)
...
CREATE TABLE `Himall_ShopBranchManagers` (
  ...
  `RealName` varchar(1000) DEFAULT NULL COMMENT '真实名称',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='门店管理员表';
...
CREATE TABLE `Himall_ShopBranchSkus` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `ProductId` bigint(20) NOT NULL COMMENT '诊疗项目id(冗余字段)',
  `SkuId` varchar(100) NOT NULL COMMENT 'SKU表Id',
  `ShopId` bigint(20) NOT NULL COMMENT '诊所id(冗余字段)',
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=906 DEFAULT CHARSET=utf8 COMMENT='诊所分店SKU信息';

-- ----------------------------
-- Table structure for Himall_ShopBranchTags
-- ----------------------------
DROP TABLE IF EXISTS `Himall_ShopBranchTags`;
CREATE TABLE `Himall_ShopBranchTags` (
...
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=193 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShoppingCarts` (
  ...
  KEY `himall_shoppingcarts_ibfk_3` (`ShopBranchId`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2360 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Shops` (
  ...
  `SenderName` varchar(100) DEFAULT NULL COMMENT '诊所发货人名称',
  `SenderAddress` varchar(100) DEFAULT NULL COMMENT '诊所发货人地址',
  `SenderPhone` varchar(100) DEFAULT NULL COMMENT '诊所发货人电话',
  ...
  `SenderRegionId` int(11) DEFAULT NULL COMMENT '诊所发货人省市区',
  `BusinessLicenseCert` varchar(120) DEFAULT NULL COMMENT '营业执照证书',
  `ProductCert` varchar(120) DEFAULT NULL COMMENT '诊疗项目证书',
  ...
  `AutoAllotOrder` tinyint(1) DEFAULT NULL COMMENT '诊所是否开启自动分配预约单',
  `ProvideInvoice` tinyint(1) DEFAULT NULL COMMENT '是否提供发票',
  PRIMARY KEY (`Id`),
...
CREATE TABLE `Himall_ShopVistis` (
  ...
  `StatisticFlag` bit(1) NOT NULL COMMENT '是否已经统计(0：未统计,1已统计)',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3352 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_ShopWithDraw` (
  ...
  `SellerName` varchar(100) NOT NULL COMMENT '申请诊所用户名',
  `DealTime` datetime DEFAULT NULL COMMENT '处理时间',
  `ShopRemark` varchar(1000) DEFAULT NULL COMMENT '诊所备注',
...
CREATE TABLE `Himall_SKUs` (
  `Id` varchar(100) NOT NULL COMMENT '诊疗项目ID_颜色规格ID_颜色规格ID_尺寸规格',
...
) ENGINE=InnoDB AUTO_INCREMENT=6673 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=927 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_StatisticOrderComments` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ShopId` bigint(20) NOT NULL,
  `CommentKey` int(11) NOT NULL COMMENT '评价的枚举（宝贝与描述相符 诊所得分）',
...
) ENGINE=InnoDB AUTO_INCREMENT=213 DEFAULT CHARSET=gbk ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_Theme` (
  ...
  `ClassifiedsColor` varchar(50) DEFAULT NULL COMMENT '诊疗项目分类栏',
  PRIMARY KEY (`ThemeId`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2037 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `Himall_WeiXinMsgTemplate` (
  ...
  `UserInWxApplet` tinyint(4) unsigned zerofill DEFAULT NULL COMMENT '是否小程序微信通知',
  PRIMARY KEY (`Id`)
...
-- ----------------------------
-- Table structure for Himall_WXAppletFormDatas
-- ----------------------------
...
-- ----------------------------
-- Table structure for Himall_WXSmallChoiceProducts
-- ----------------------------
