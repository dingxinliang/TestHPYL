...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class ShopController : BaseSellerController
    {
        ...
        {
            ShopInfo shop = this._iShopService.GetShop(base.CurrentSellerManager.ShopId, false);
            ((dynamic)base.ViewBag).ProvideInvoice = shop.ProvideInvoice.HasValue ? shop.ProvideInvoice.Value : false;
            return base.View();
        }
        /// <summary>
        /// 发票信息设置
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult InvoiceSetting(bool enable)
        {
            ShopInfo shop = new ShopInfo
            {
                Id = base.CurrentSellerManager.ShopId,
                ProvideInvoice = new bool?(enable)
            };
            this._iShopService.UpdateShop(shop);
