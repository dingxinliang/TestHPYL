...
optionShop = {
    tooltip: {
        ...
        formatter: function (params, ticket, callback) {
            ...
            var html = '';
            if (1 == type) {
                var t1 = '<span style="text-align:left;">诊所：<b style="color:yellow;font-size:14px;">' + mapNameShop[params[0][1] - 1] + '</b></span>';
                ...
                var t1 = '<span style="text-align:left;">诊所：<b style="color:yellow;font-size:14px;">' + mapNameShop[params[0][1] - 1] + '</b></span>';
                var t2 = '<span style="text-align:left;">使用额：<b style="color:yellow;font-size:14px;">' + params[0][2] + '</b>元</span>';
                html = ['<div style="text-align:left;">', t1, '<br />', t2, '</div>'];
            }
