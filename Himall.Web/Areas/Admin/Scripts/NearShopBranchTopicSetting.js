...
$(function () {
    ...
    $("#slideImagesTable2").on("click", '.glyphicon-circle-arrow-up', function () {
        ...
        if (rowIndex > 0) {
            ...
            changeSequence2(oriRowNumber, newRowNumber, function () {
                $("#slideImagesTable2").hiMallDatagrid('reload', {});
            });
        }
    ...
    $('#topicSearchButton2').unbind('click').click(function () {
        $("#topicGrid2").hiMallDatagrid('reload', getQuery2());
    });
});
...
function initSlideImagesTable2() {
    //商品表格
    $("#slideImagesTable2").hiMallDatagrid({
...
function chooseTopicJumpUrl2() {
    ...
    switch (selectValue) {
        case "1":
            ...
            title = "门店标签";
            desc = "描述";
            jumpUrl = "http://" + window.location.host + "/m-wap/ShopBranch/Tags/{0}";
            break;
        case "2":
            queryUrl = "/admin/NearShopBranch/ShopList";
            title = "门店";
            desc = "标签";
            jumpUrl = "http://" + window.location.host + "/m-wap/ShopBranch/Index/{0}";
            break;
        case "3":
            queryUrl = "/admin/MobileTopic/list";
            title = "专题";
            desc = "标签";
            jumpUrl = "http://" + window.location.host + "/m-wap/topic/detail/{0}";
            break;
    }
...
function generateSlideImageInfo2() {
    ...
    slideImage.imageUrl = $("#imgUrl2").himallUpload('getImgSrc');
