...
$(function () {
    ...
    HiShop.Config.AjaxUrl = {
        ...
        getPage: "/SellerAdmin/TemplateVisualizationAjax/Hi_Ajax_GetTemplateByID",//获取模板（用户诊所） 
        /*页面操作相关  end*/
        ...
        /*诊疗项目相关 start*/
        GoodsList: "/SellerAdmin/TemplateVisualizationAjax/Hi_Ajax_GetGoodsList",//诊疗项目列表
        goodGroup: "/SellerAdmin/TemplateVisualizationAjax/Hi_Ajax_GoodsGourp",//诊疗项目分类
        /*诊疗项目相关 end*/
