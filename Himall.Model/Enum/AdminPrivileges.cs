...
namespace Himall.Model
{
    public enum AdminPrivilege
    {
        ...
        ///*诊所*/
        [Privilege("诊所", "诊所管理", 5001, "shop/management?type=Auditing", "Shop")]
        ShopManage = 5001,
        [Privilege("诊所", "诊所套餐", 5002, "ShopGrade/management", "ShopGrade")]
        ShopPackage = 5002,
        [Privilege("诊所", "门店管理", 5006, "ShopBranch/Management", "ShopBranch", "", AdminCatalogType.Default, "")]
        ShopBranchManagement = 5006,
        //[Privilege("诊所", "周边门店设置", 5007, "Weixin/NearShopBranchSetting", "WeiXin", "", AdminCatalogType.Default, "")]
        //NearShopBranchSetting = 5007,
        [Privilege("诊所", "财务管理", 5003, "Billing/index", "Billing")]
        SettlementManage = 5003,
        [Privilege("诊所", "保证金管理", 5004, "CashDeposit/Management", "CashDeposit")]
        CashDepositManagement = 5004,
        [Privilege("诊所", "诊所提现管理", 5005, "ShopWithDraw/Management", "ShopWithDraw")]
        ...
        [Privilege("统计", "诊所统计", 6003, "Statistics/NewShop", "statistics", "newshop")]
        ShopStatistics = 6003,
        ...
        [Privilege("分佣", "分佣管理", 7101, "DistributionMarket/management", "DistributionMarket")]
        DistributionMarket = 7101,
        [Privilege("分佣", "医生管理", 7102, "Promoter/management", "Promoter")]
        Promoter = 7102,
        [Privilege("分佣", "分佣业绩管理", 7103, "Proformance/management", "Proformance")]
        Proformance = 7103,
        //[Privilege("分佣", "分佣首页设置", 7104, "DistributionShop/HomePageSetting", "DistributionShop")]
        ...
        //Vshop = 10001,
        //[Privilege("微商城", "底部导航栏", 10007, "Weixin/WXMobileFootMenu", "Weixin", "", AdminCatalogType.Default, "")]
