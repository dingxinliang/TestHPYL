...
namespace Himall.Model
{
    public enum AdminPrivilege
    {
        ...
        ShopPackage = 5002,
        [Privilege("店铺", "门店管理", 5006, "ShopBranch/Management", "ShopBranch", "", AdminCatalogType.Default, "")]
        ShopBranchManagement = 5006,
        [Privilege("店铺", "周边门店设置", 5007, "Weixin/NearShopBranchSetting", "WeiXin", "", AdminCatalogType.Default, "")]
